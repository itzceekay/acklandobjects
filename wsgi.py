...
def number12_2():
    if request.method == 'POST':
        ...
        comment = Comment12_3(content=request.form['user_input_12_2'])
        db.session.add(comment)
        db.session.commit()

        user_input_12_3 = user_input_12_3.lower().rstrip(".").split()
        keywords_12_3 = ["tense", "nervous", "scared", "hunched", "escape", "sulky", "defiant", "brooding", "crouched",
...
def number13():
    if request.method == 'POST':
        ...
        keywords_13_1 = ["eyes", "clothing", "headdress", "jewelry", "face", "head", "earrings", "necklace", "objects",
...
def number14():
    if request.method == 'POST':
        ...
        keywords_14_1 = ["violent", "scary", "torn", "stormy", "spooky", "destroyed", "desolate", "abandoned", "swirly",
...
def number14_2():
    if request.method == 'POST':
        ...
        keywords_14_3 = ["bad", "dangerous", "destructive", "negative", "terrible", "inequality", "lack", "resources"]
...
def number15():
    if request.method == 'POST':
        ...
        keywords_15_1 = ["vision", "holy", "praying", "begging", "receiving", "monk", "angel", "seraph", "stigmata",
                         "miracle", "looking", "up"]
...
def number15_1():
    if request.method == 'POST':
        ...
        keywords_15_2 = ["kneeling", "arms", "hands", "looking", "eyes", "pale", "gaze", "wounds", "red", "open", "up",
...
def number16():
    if request.method == 'POST':
        ...
        keywords_16_1 = ["man", "woman", "weapons", "knife", "sword", "spear", "bracelets", "clothing", "beard", "eyes",
...
def number17():
    if request.method == 'POST':
        ...
        keywords_17_1 = ["workers", "laborers", "bent", "sitting", "working", "sketchy", "detailed", "clothing",
